...
<body>
	...
	<div id="userinfo-container">
	    <div class="information">
	        <p> 반갑습니다! <b><%=username %></b>님, 무엇을 도와드릴까요 ?</p>
	        <p> 당신은 현재 : <b><%= team%></b> 구독 중 </p>
	        <% 
				if(team.equals("Arsenal")) out.println("<img src=\"../pics/Arsenal.png\" style=\"height: 10rem\">");
	   			if(team.equals("Aston Villa")) out.println("<img src=\"../pics/Aston Villa.png\" style=\"height: 10rem\">");
				if(team.equals("AFC Bournemouth")) out.println("<img src=\"../pics/AFC Bournemouth.png\" style=\"height: 10rem\">");
				if(team.equals("Brentford")) out.println("<img src=\"../pics/Brentford.png\">");
				if(team.equals("Brighton & Hove Albion")) out.println("<img src=\"../pics/Brighton & Hove Albion.png\" style=\"height: 10rem\">");
				if(team.equals("Burnley")) out.println("<img src=\"../pics/Burnley.png\" style=\"height: 10rem\">");
				if(team.equals("Chelsea")) out.println("<img src=\"../pics/Chelsea.png\" style=\"height: 10rem\">");
				if(team.equals("Crystal Palace")) out.println("<img src=\"../pics/Crystal Palace.png\" style=\"height: 10rem\">");
				if(team.equals("Everton")) out.println("<img src=\"../pics/Everton.png\" style=\"height: 10rem\">");
				if(team.equals("Fulham")) out.println("<img src=\"../pics/Fulham.png\" style=\"height: 10rem\">");
				if(team.equals("Liverpool")) out.println("<img src=\"../pics/Liverpool.png\" style=\"height: 10rem\">");
				if(team.equals("Luton Town")) out.println("<img src=\"../pics/Luton Town.png\" style=\"height: 10rem\">");
				if(team.equals("Manchester City")) out.println("<img src=\"../pics/Manchester City.png\" style=\"height: 10rem\">");
				if(team.equals("Manchester United")) out.println("<img src=\"../pics/Manchester United.png\" style=\"height: 10rem\">");
				if(team.equals("Newcastle United")) out.println("<img src=\"../pics/Newcastle United.png\" style=\"height: 10rem\">");
				if(team.equals("Nottingham Forest")) out.println("<img src=\"../pics/Nottingham Forest.png\" style=\"height: 10rem\">");
				if(team.equals("Sheffield United")) out.println("<img src=\"../pics/Sheffield United.png\" style=\"height: 10rem\">");
				if(team.equals("Tottenham Hotspur")) out.println("<img src=\"../pics/Tottenham Hotspur.png\" style=\"height: 10rem\">");
				if(team.equals("West Ham United")) out.println("<img src=\"../pics/West Ham United.png\" style=\"height: 10rem\">");
				if(team.equals("Wolverhampton Wanderers")) out.println("<img src=\"../pics/Wolverhampton Wanderers.png\" style=\"height: 10rem\">");
	    ...
	    <div class="update-box">
	        ...
	        <form action="update-userinfo.jsp" method="POST">
	            ...
	            <div id="pw-check-container">
		            ...
		            <input type="password" id="password-confirm" style="margin-top: 0;" name="password-confirm" oninput="checkPasswordMatch()" placeholder="비밀번호 확인" required>
	            </div>
